/* Vendored from contracts/view-models.ts (design package 1.0.0, frozen). */
...
export interface Note {note_id:Id;paper_id:Id;paper_version_id:Id;claim_id:Id|null;evidence_id?:Id|null;body:string;revision:number;updated_at:ISODateTime;}
